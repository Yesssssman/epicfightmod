...
public class MobAttackPatterns {
	static List<AttackAnimation> BIPED_ARMED = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> BIPED_UNARMED = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> DROWNED_ARMED_SPEAR = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> BIPED_MOUNT_SWORD = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> ENDERMAN_KNEE = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> ENDERMAN_KICK_COMBO = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> ENDERMAN_SPINKICK = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> ENDERMAN_JUMPKICK = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> GOLEM_SWINGARM = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> GOLEM_HEADBUTT = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> GOLEM_SMASH_GROUND = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> HOGLIN_HEADBUTT = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> RAVAGER_HEADBUTT = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> RAVAGER_SMASHING_GROUND = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> SPIDER = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> SPIDER_JUMP = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> VINDICATOR_AXE = new ArrayList<AttackAnimation> ();
	static List<AttackAnimation> SKELETON_ARMED = new ArrayList<AttackAnimation> ();
	
	public static void setMobAttackPatterns() {
