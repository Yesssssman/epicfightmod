...
public class DrownedData extends ZombieData<DrownedEntity> {
	...
	public void setAIAsUnarmed() {
		...
		this.orgEntity.goalSelector.addGoal(0, new AttackPatternGoal(this, this.orgEntity, 0.0D, 1.5D, true, MobAttackPatterns.BIPED_UNARMED));
	}
	
	@Override
	public void setAIAsArmed() {
		if (this.orgEntity.getHeldItemMainhand().getItem() == Items.TRIDENT) {
			this.orgEntity.goalSelector.addGoal(0, new AttackPatternGoal(this, this.orgEntity, 0.0D, 2.0D, true, MobAttackPatterns.DROWNED_ARMED_SPEAR));
