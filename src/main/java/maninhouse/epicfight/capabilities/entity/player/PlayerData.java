...
import maninhouse.epicfight.entity.eventlistener.GetAttackSpeedEvent;
import maninhouse.epicfight.entity.eventlistener.PlayerEventListener;
...
public abstract class PlayerData<T extends PlayerEntity> extends LivingData<T> {
	...
	protected void initAttributes() {
		...
		this.orgEntity.getAttribute(ModAttributes.MAX_STAMINA.get()).setBaseValue(15.0D);
		this.orgEntity.getAttribute(ModAttributes.OFFHAND_IMPACT.get()).setBaseValue(0.5D);
	}
	...
	public float getMaxStamina() {
		ModifiableAttributeInstance stun_resistance = this.orgEntity.getAttribute(ModAttributes.MAX_STAMINA.get());
