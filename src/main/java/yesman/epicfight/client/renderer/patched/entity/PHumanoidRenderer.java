...
@OnlyIn(Dist.CLIENT)
public abstract class PHumanoidRenderer<E extends LivingEntity, T extends LivingEntityPatch<E>, M extends HumanoidModel<E>> extends PatchedLivingEntityRenderer<E, T, M> {
