...
public class ClientModBusEvent {
	...
	public static void onParticleRegistry(final ParticleFactoryRegisterEvent event) {
    	...
    	particleEngine.register(EpicFightParticles.EXPANSIVE_DUST.get(), DustParticle.ExpansiveDustProvider::new);
    	particleEngine.register(EpicFightParticles.CONTRACTIVE_DUST.get(), DustParticle.ContractiveDustProvider::new);
