...
public class Mesh {
	...
	public Mesh(float[] positionList, float[] noramlList, float[] textureList, int[] jointIdList, float[] weightList, int[] indexList, int[] weightCountList, int vertexCount, int drawCount) {
