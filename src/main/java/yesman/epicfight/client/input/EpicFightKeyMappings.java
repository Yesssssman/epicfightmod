...
public class EpicFightKeyMappings {
	...
	public static final KeyMapping ATTACK = new  KeyMapping("key." + EpicFightMod.MODID + ".attack", InputConstants.Type.MOUSE, 0, "key." + EpicFightMod.MODID + ".combat");
	...
	public static final KeyMapping MOVER_SKILL = new  KeyMapping("key." + EpicFightMod.MODID + ".mover_skill", InputConstants.Type.KEYSYM, InputConstants.KEY_SPACE, "key." + EpicFightMod.MODID + ".combat");
