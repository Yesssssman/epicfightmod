...
public abstract class Property<T> {
	...
	public static class ActionAnimationProperty<T> extends Property<T> {
		/**
		 * This property will set the entity's delta movement to (0, 0, 0) when begin to play if true.
		 */
		 ...
		 */
		public static final ActionAnimationProperty<DynamicCoordFunction> DYNAMIC_ACTION_COORD = new ActionAnimationProperty<DynamicCoordFunction> ();
		/**
	...
	@FunctionalInterface
	public static interface DynamicCoordFunction {
		public void set(ActionAnimation self, LivingEntityPatch<?> entitypatch, TransformSheet transformSheet);
	}
