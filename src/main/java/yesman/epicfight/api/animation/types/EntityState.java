...
public class EntityState {
	...
	final boolean basicAttackPossible;
	final boolean skillExecutionPossible;
	...
	private EntityState(boolean cameraLock, boolean movementLock, boolean attacking, boolean basicAttackPossible, boolean skillExecutionPossible, boolean inaction, boolean hurt, int phaseLevel, Function<DamageSource, Boolean> invulnerabilityChecker) {
		...
		this.basicAttackPossible = basicAttackPossible;
		this.skillExecutionPossible = skillExecutionPossible;
	...
	public boolean basicAttackPossible() {
		return this.basicAttackPossible;
	}
	
	public boolean skillExecutionPossible() {
		return this.skillExecutionPossible;
	}
