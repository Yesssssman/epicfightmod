...
public class EpicFightParticles {
	...
	public static final RegistryObject<SimpleParticleType> EXPANSIVE_DUST = PARTICLES.register("dust_expansive", () -> new SimpleParticleType(true));
	public static final RegistryObject<SimpleParticleType> CONTRACTIVE_DUST = PARTICLES.register("dust_contractive", () -> new SimpleParticleType(true));
	...
	public static final RegistryObject<HitParticleType> EVISCERATE = PARTICLES.register("eviscerate", () -> new HitParticleType(true, HitParticleType.POSITION_MIDDLE_OF_TARGET, HitParticleType.ARGUMENT_ATTACKER_DIRECTION));
