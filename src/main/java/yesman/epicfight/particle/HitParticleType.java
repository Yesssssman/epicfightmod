...
public class HitParticleType extends SimpleParticleType {
	public static final BiFunction<Entity, Entity, Vector3d> POSITION_CENTER_OF_TARGET = (target, attacker) -> {
	...
	public HitParticleType(boolean p_i50791_1_) {
		this(p_i50791_1_, POSITION_CENTER_OF_TARGET, ARGUMENT_ZERO);
	}
