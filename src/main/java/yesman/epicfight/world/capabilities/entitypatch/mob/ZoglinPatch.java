...
public class ZoglinPatch extends MobPatch<Zoglin> {
	...
	public void initAI() {
		...
		BrainRemodeler.replaceBehavior(this.original.getBrain(), Activity.FIGHT, 11, RunIf.class, new AnimatedCombatBehavior<>(this, MobCombatBehaviors.HOGLIN.build(this)));
