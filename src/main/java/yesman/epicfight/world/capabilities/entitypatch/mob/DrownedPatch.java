...
public class DrownedPatch extends ZombiePatch<Drowned> {
	...
	public void initAnimator(ClientAnimator animator) {
		animator.addLivingMotion(LivingMotion.IDLE, Animations.ZOMBIE_IDLE);
		animator.addLivingMotion(LivingMotion.WALK, Animations.ZOMBIE_WALK);
		animator.addLivingMotion(LivingMotion.FALL, Animations.BIPED_FALL);
		animator.addLivingMotion(LivingMotion.MOUNT, Animations.BIPED_MOUNT);
		animator.addLivingMotion(LivingMotion.DEATH, Animations.BIPED_DEATH);
	}
