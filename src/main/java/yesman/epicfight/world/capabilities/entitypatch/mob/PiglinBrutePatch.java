...
public class PiglinBrutePatch extends HumanoidMobPatch<PiglinBrute> {
	...
	public void onJoinWorld(PiglinBrute entityIn, EntityJoinWorldEvent event) {
		...
		BrainRemodeler.replaceBehavior(this.original.getBrain(), Activity.FIGHT, 12, MeleeAttack.class, new AnimatedFightBehavior(this, MobCombatBehaviors.BIPED_ARMED_ATTACKS.build(this)));
	}
