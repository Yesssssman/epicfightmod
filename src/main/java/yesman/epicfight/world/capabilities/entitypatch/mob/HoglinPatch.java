...
public class HoglinPatch extends MobPatch<HoglinEntity> {
	@Override
	public void initAI() {
		super.initAI();
		...
		BrainRecomposer.replaceBehavior(this.original.getBrain(), Activity.FIGHT, 13, SupplementedTask.class, new AnimatedCombatBehavior<>(this, MobCombatBehaviors.HOGLIN.build(this)));
		BrainRecomposer.removeBehavior(this.original.getBrain(), Activity.FIGHT, 14, SupplementedTask.class);
	}
